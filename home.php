    ...
    <nav>
        <div class="logo-name">
            ...
            <?php
                            ...
                            include 'config.php';
                            $var = $_SESSION['userID'];
                            $selectQuery = "SELECT * FROM user WHERE userID = '$var'";
        ...
        <div class="dash-content">
            ...
            <div class="activity">
                ...
                <i class="fa-solid fa-user"></i>
                    <span class="text">Admin Table</span>
                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <form id="modalSignUp" action="addUserAdmin.php" method="post">
                        ...
                        <?php if (isset($_GET['success'])) { ?>
     	                ...
     	                <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="" readonly class="form-control" name="registerID" id="exampleInputID1" placeholder="">   
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Full Name</label>
                                <input type="" class="form-control" name="registerFullname" id="exampleInputFullName1" placeholder="Enter Full Name">   
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUsername1">Username</label>
                                <input type="" class="form-control" name="registerUsername" id="exampleInputUsername1" placeholder="Enter Username">   
                            </div>
                            <div class="form-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="btnCaption" name="insertData" class="btn btn-primary">Save data</button>
                            </div>
                        </div>
                        </form>
                    </div>
                ...
                <div class="activity-data table-responsive">
                    ...
                    <table class="table table-hover table-striped" id="myTable">
                        <thead class="thead-dark">
                            <tr>
                                <th data-field="id" data-sortable="true">Resident ID</th>
                                <th>Resident Full Name</th>
                                <th>Resident Username</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                ?>
                                    ...
                                    <td><button type="button" class="btn btn-success editBtnResident"><i class="fa-solid fa-user-pen"></i> Edit User</button></td>
                                    <td><button type="button" class="btn btn-danger deleteBtnResident"><i class="fa-solid fa-trash-can"></i> Delete User</button></td>
                                    </tr>
                    ...
                    <div class="sideBySide">
                    <button type="button" class="btn btnAdd" id="showModal" data-toggle="modal" data-target="#exampleModal">
                    <i class="fa-solid fa-plus"></i> Add Admin
                    </button>
                    <div class="top1">
                        <div class="search-box">
                            <i class="fa-solid fa-magnifying-glass"></i>
                            <input type="text" id="adminInput" placeholder="Search Admin">
                        </div>
                    ...
                    <table class="table table-hover table-striped" id="adminTable">
                        ...
                        <thead class="thead-dark">
                            <tr>
                                <th data-field="id" data-sortable="true">Admin ID</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                ?>
                                    ...
                                    <td><button type="button" class="btn btn-success editBtn"><i class="fa-solid fa-user-pen"></i> Edit User</button></td>
                                    <td><button type="button" class="btn btn-danger deleteBtn"><i class="fa-solid fa-trash-can"></i> Delete User</button></td>
                                    </tr>
...
$(document).ready(function (){
  ...
  $(".editBtnResident").on('click', function(){
        ...
        $('#modalSignUp').attr('action', 'residentUpdateCheck.php');
        
        
    });


    $(".deleteBtnResident").on('click', function(){
        ...
        $('#modalSignUp').attr('action', 'residentDeleteCheck.php');
    ...
    $('#showModalResident').click(function() {
    //Code to be executed when close is clicked
    $('#exampleModalLabel').html('Add Resident');
    ...
    $('#exampleID1').hide();
    $('#modalSignUp').attr('action', 'addResidentCheck.php');
    $('#btnCaption').text("Save Changes");
    ...
    //Code to be executed when close is clicked
    $('#exampleModalLabel').html('Add Admin');
    $("#exampleInputPassword1").show();
    $("#exampleInputPassword2").show();
    $('#label1').show();
    $('#label2').show();
